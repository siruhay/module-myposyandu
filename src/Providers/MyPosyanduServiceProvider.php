...
namespace Module\MyPosyandu\Providers;

use Illuminate\Support\Facades\Gate;
use Illuminate\Support\ServiceProvider;

class MyPosyanduServiceProvider extends ServiceProvider
{
    /**
    ...
    protected function discoverCommands(): array
    {
        ...
        foreach($this->app->files->allFiles($commandPath) as $command) {
            $className = 'Module\\MyPosyandu\\Commands\\' . str($command->getBasename())->before('.php')->toString();
